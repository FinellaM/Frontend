    ...
    return (
        <div className="container text-center">
            ...
            <div className="about-earth">
                <div>
                    <img src="./earth_swish.png" alt="" id="earthHighlight" />
            ...
            <div className="about-communities">
                <div>
                    <img src="./communities_swish.png" alt="" id="communityHighlight" />
                    <h2>Communities</h2> {/* sub section title */}
                </div>
                <div className="pic-left">
                    <div className="vidColumn">
                        <img src="./wave_logo.png" alt="Project WAVE logo" className="pic-left" />
                        <img src="./communities_animation_placeholder.png" alt="Project WAVE" className="pic-left" />
                    </div>
                </div>
                <div className="text-right">
            ...
            <div className="man-behind-brand">
                ...
                <div className="text-left">
                    ...
                    <img src="./man_behind_brand.png" alt="Man behind the brand" className="pic-left" />
                    <div>
                    ...
                    <img src="./climate_positive.png" alt="climate positive archievement" className="pic-right" />
                    ...
                    <video className="pic-left" autoPlay loop muted playsInline>
            ...
            <div className="text-center">
                ...
                <p><strong>Marina Bradford</strong></p>
            ...
            <div className="aboutUsAccolates-tri">
                <img src="./infographics_recycle.png" alt="recycling message" className="imageAccolatesTri" />
                <img src="./infographic_planetmark.png" alt="planet mark certification" className="imageAccolatesTri" />
                <img src="./infographic_emissions.png" alt="emissions goal" className="imageAccolatesTri" />
            </div> 
            <div className="aboutUsAccolatesDuo">
                <img src="./infographic_cans.png" alt="statistics on cans" className="imageAccolateDuo" />
                <img src="./infographic_rucksacks.png" alt="statistics on rucksacks and sleeping bags" className="imageAccolateDuo" />
                <img src="./infographic_co2.png" alt="statistics on Carbon dioxide offset" className="imageAccolateDuo" />
                <img src="./infographic_donation.png" alt="statistics on money donated to charity" className="imageAccolateDuo" />
            </div>
        </div>
    );
}
