    ...
    return (
        <div className="container text-center">
            ...
            <div className="man-behind-brand">
                ...
                <div>
                    <p><strong>Feel Good drinks are a range of 100% natural, great tasting, fruity sparkling waters that contain no nasty additives, added sugars or sweetners, making them a healthy choice for all.</strong></p>
                </div>
                <div>
                ...
                <div>
                    <p><strong>We have established The Feel Good 3% People Planet Fund. It's out own way of giving back.</strong></p>
                </div>
                <div>
