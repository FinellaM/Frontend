    ...
    <div className="pageBody">
      ...
      <SlCard id="missionStatement">
        <div id="missionHeader">
          <h1>Our Mission</h1>
          <h3>We are a purpose driven brand on a mission to lead change from within the drinks industry.</h3>
        </div>
        <div id="missionObj">
          <div id="missionPointers">
        ...
        <div slot="footer">
          <div id="missionFooter">
            <div id="missonFooter-Img">
              <img src="" alt="quotation icon" />
            </div>
            <div id="missionFooter-text">
              <h4 style={{fontWeight: "bold", textAlign: "center"}}>As Ed Woolner, the man behind the brand says,</h4>
              <p id="quote">“We all know how precarious our planet’s future is, how hard it is to protect and restore it, but we can have a positive impact - as custodians of the land, parents and consumers. With each choice we can make a difference and here at Feel Good we have the opportunity to support others with those choices too. That makes me very happy.”</p>
            </div>
          </div>
          <SlButton style={{ width:"15%", display: "flex", alignContent: "center"}}>Find Out More</SlButton>
        </div>
      </SlCard>
